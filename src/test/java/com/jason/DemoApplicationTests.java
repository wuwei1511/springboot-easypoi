...
import com.jason.entity.ClassName;
import com.jason.entity.Person;
import com.jason.util.FileUtilTest;
...
//        File file = new File(FileUtilTest.getWebRootPath("F:\\prodemo\\testFiles\\海贼王.xls"));
    ...
    public void importTest() {
        ...
        List<ClassName> list = ExcelImportUtil.importExcel(new File("F:\\prodemo\\testFiles\\sameName.xls"), ClassName.class, params);
